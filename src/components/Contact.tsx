...
const Contact = () => {
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/Chaitanya933",
      icon: Github,
      username: "@Chaitanya933",
      description: "Check out my code repositories and contributions",
      color: "hover:text-gray-900 dark:hover:text-gray-100"
    },
    {
      name: "LinkedIn", 
      url: "https://linkedin.com/in/kalipindi-chaitanya-kumar-3556742b5",
      icon: Linkedin,
      username: "Kalipindi Chaitanya Kumar",
      description: "Connect with me professionally",
      color: "hover:text-blue-600"
    },
    {
      name: "Instagram",
      url: "https://instagram.com/mr_nani_.13",
      icon: Instagram,
      username: "@mr_nani_.13",
      description: "Follow my journey and daily updates",
      color: "hover:text-pink-600"
    },
    {
      name: "HackerRank",
      url: "https://hackerrank.com/profile/nani2222kalipin1",
      icon: Award,
      username: "nani2222kalipin1",
      description: "View my coding challenges and rankings",
      color: "hover:text-green-600"
    },
    {
      name: "WhatsApp",
      url: "https://wa.me/916305845316",
      icon: MessageCircle,
      username: "+91 6305845316",
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "chaitukalipindi@gmail.com",
      href: "mailto:chaitukalipindi@gmail.com"
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+91 6305845316",
      href: "tel:+916305845316"
    },
    {
      icon: MapPin,
      label: "Location",
      value: "Hyderabad, India",
      href: "https://www.google.com/maps?q=17.4727502,78.3891665"
    }
  ];
      ...
      <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              <Card className="p-6 bg-gradient-card border-primary/10">
                ...
                <a href='mailto:chaitukalipindi@gmail.com'>
              ...
              <Card className="p-6 bg-gradient-hero text-white border-0 shadow-glow">
                ...
                <div className="flex gap-3">
                  <Button variant="secondary" size="sm" asChild>
                    <a href="https://github.com/Chaitanya933" target="_blank" rel="noopener noreferrer">
                      <Github className="w-4 h-4 mr-2" />
                      GitHub
                    </a>
                  </Button>
                  <Button variant="outline" size="sm" className="bg-white/10 border-white/30 text-white hover:bg-white/20" asChild>
                    <a href="https://www.linkedin.com/in/kalipindi-chaitanya-kumar-3556742b5/" target="_blank" rel="noopener noreferrer">
        ...
        >
          <p className="text-muted-foreground">
            © 2024 Kalipindi Chaitanya Kumar.
          </p>
        </motion.div>
      </div>
    </section>
