        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Ambitious engineering student seeking internship/job to apply Python, Web framework & Web development skills. 
              Eager to contribute expertise and learn in a dynamic team.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Ready to implement programming skills and problem-solving abilities to contribute to greater projects and enhance skills. 
            ...
            <div className="pt-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-muted-foreground">Continuous learning and skill enhancement</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></div>
                  <span className="text-muted-foreground">Building innovative web solutions</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></div>
                  <span className="text-muted-foreground">Contributing to meaningful projects</span>
                </li>
              </ul>
            </div>
          </motion.div>
