    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 animate-slide-up">
          <span className="gradient-text">Kalipindi Chaitanya Kumar</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slide-up" style={{ animationDelay: '0.6s' }}>
          ...
          <Button variant="outline" size="lg" onClick={handleDownloadResume} className="w-full sm:w-auto" asChild>
            <a href='https://drive.google.com/file/d/1dBHkoRCFxboZ0sdMOaiB9xT8JWbHZoJd/view?usp=sharing' target='_blank' rel="noopener noreferrer">
